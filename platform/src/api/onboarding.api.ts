...
import type { OnboardingStatus, ReadInviteDTO, ReadOrgDTO } from '../types/api'
...
export const onboardingApi = {
  ...
  requestJoin: async (): Promise<{ orgId: string; autoJoined: boolean }> =>
  ...
  acceptInvite: async (token: string): Promise<{ orgId: string }> =>
